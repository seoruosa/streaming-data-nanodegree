...
def produce():
    ...
    #       See: https://docs.confluent.io/current/kafka-rest/api.html#post--topics-(string-topic_name)
    resp = requests.post(
        f"{REST_PROXY_URL}/topics/class4.exercise5.click", data=json.dumps(data), headers=headers  # TODO
    )
...
#  kafka-console-consumer --bootstrap-server localhost:9092 --topic class4.exercise5.click --from-beginning
def main():
